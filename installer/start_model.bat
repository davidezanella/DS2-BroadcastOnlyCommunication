@ECHO OFF
TITLE BroadcastOnlyCommunication
...
CD BroadcastOnlyCommunication

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./BroadcastOnlyCommunication.rs
